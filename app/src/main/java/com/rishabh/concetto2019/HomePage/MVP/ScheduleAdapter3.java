...
public class ScheduleAdapter3 extends RecyclerView.Adapter<ScheduleAdapter3.ViewHolder> {

    List<ScheduleModel> list;
    Context context;

    public ScheduleAdapter3(List<ScheduleModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public ScheduleAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.card_schedule,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ScheduleAdapter3.ViewHolder holder, int position) {
