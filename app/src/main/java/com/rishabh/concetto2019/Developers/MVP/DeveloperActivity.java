...
public class DeveloperActivity extends AppCompatActivity implements DeveloperAdapter.onNoteClickListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list.add(new Developers("Sujay Kaushik","https://github.com/sujaykaushik008","https://www.linkedin.com/in/sujay-kaushik-730827180","Mathematics and Commputing",R.mipmap.sujay_kaushik));
        list.add(new Developers("Rishabh Agarwal","https://github.com/rishabh-997","https://www.linkedin.com/in/rishabh-997/","Mathematics and Commputing",R.mipmap.rishabh));
